...
urlpatterns = [
    ...
    url(r'^check_file/', management_views.check_file),
    ...
    url(r'^update_sug_source/', suggest_views.update_sug_source),
    url(r'^update_sug_category/', suggest_views.update_sug_category),
    url(r'^delete_sug_category/', suggest_views.delete_sug_category),
    # 日志管理
    url(r'^log_management/', log_views.log_management),
    url(r'^get_log_info/', log_views.get_log_info),
    ...
    # url(r'^test/', mainapp_views.test),
    # url(r'^test_ajax/', mainapp_views.test_ajax),
