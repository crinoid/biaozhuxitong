...
class ZhenDuan():
    def __init__(self):
        # 症状诊断
        self.zd_segment = mongo.db.zd_segment  # 分词
        self.zd_suggest = mongo.db.zd_suggest  # 标注
        self.zd_file = mongo.db.zd_file
        self.zd_category = mongo.db.zd_category
    ...
    def get_suggest_from_seg(self,seg):
        return mongo.get_suggest_from_seg(self.zd_suggest,seg)
    ...
    def update_seg_source(self, seg, sug, origin_msg):
        mongo.update_seg_source(self.zd_suggest, seg, sug, origin_msg)
    ...
    def get_seg_source(self, segs, max):
        return mongo.get_seg_source(self.zd_suggest, segs, max)
