...
(function (factory) {
    ...
    $h = {
        ...
        ifSet: function ifSet(needle, haystack, def) {
            def = def || '';
            return haystack && (typeof haystack === 'undefined' ? 'undefined' : _typeof(haystack)) === 'object' && needle in haystack ? haystack[needle] : def;
        },
        ...
        cleanZoomCache: function cleanZoomCache($el) {
        ...
        setOrientation: function setOrientation(buffer, callback) {
            var scanner = new DataView(buffer),
                idx = 0,
                value = 1,
                // Non-rotated is the default
            maxBytes,
                uInt16,
                exifLength;
        ...
        validateOrientation: function validateOrientation(file, callback) {
        ...
        adjustOrientedImage: function adjustOrientedImage($img, isZoom) {
    ...
    FileInput.prototype = {
            ...
            self.previewCache = {
                ...
                get: function get(i, isDisabled) {
                    var ind = 'init_' + i,
                        ...
                        parseTemplate = function parseTemplate(cat, dat, fn, ft, id, ftr, ind, fc, t) {
        ...
        _getFrame: function _getFrame(id) {
            var self = this,
                $frame = $('#' + id);
            if (!$frame.length) {
        ...
        _initUploadSuccess: function _initUploadSuccess(out, $thumb, allFiles) {
            var self = this,
                ...
                tags,
                i;
            if (!self.showPreview || (typeof out === 'undefined' ? 'undefined' : _typeof(out)) !== 'object' || $.isEmptyObject(out)) {
                return;
            }
        ...
        _uploadSingle: function _uploadSingle(i, isBatch) {
            var self = this,
        ...
        _initPreviewActions: function _initPreviewActions() {
            ...
            $preview.find(btnRemove).each(function () {
                ...
                self._handler($el, 'click', function () {
                    ...
                    if (self.ajaxAborted instanceof _Promise) {
        ...
        _generatePreviewTemplate: function _generatePreviewTemplate(cat, data, fname, ftype, previewId, isError, size, frameClass, foot, ind, templ) {
            var self = this,
        ...
        _previewFile: function _previewFile(i, file, theFile, previewId, data, fileInfo) {
            if (!this.showPreview) {
                return;
            }
            var self = this,
        ...
        _getFileIds: function _getFileIds(skipNull) {
            var self = this;
        ...
        _setPreviewError: function _setPreviewError($thumb, i, val, repeat) {
            var self = this;
            if (i !== undefined) {
        ...
        _refreshUploadButton: function _refreshUploadButton($thumb, repeat) {
            var self = this,
        ...
        _validateImage: function _validateImage(previewId, fname, ftype, fsize, iData) {
            var self = this,
                $preview = self.$preview,
                params,
                w1,
        ...
        _getResizedImage: function _getResizedImage(config, counter, numImgs) {
            var self = this,
                img = $(config.img)[0],
        ...
        _renderMain: function _renderMain() {
            var self = this,
                ...
                preview = !self.showPreview ? '' : self._getLayoutTemplate('preview').setTokens({ 'class': self.previewClass, 'dropClass': dropCss }),
        ...
        _renderThumbProgress: function _renderThumbProgress() {
            var self = this;
            return '<div class="file-thumb-progress kv-hidden">' + self.progressTemplate.setTokens({ 'percent': '0', 'status': self.msgUploadBegin }) + '</div>';
        },
        ...
        _renderFileActions: function _renderFileActions(showUpl, showDwn, showDel, showZoom, showDrag, disabled, url, key, isInit, dUrl, dFile) {
        ...
        _filterDuplicate: function _filterDuplicate(file, files, fileIds) {
            var self = this,
        ...
        _change: function _change(e) {
            var self = this,
                $el = self.$element;
            if (!self.isAjaxUpload && $h.isEmpty($el.val()) && self.fileInputCleared) {
                // IE 11 fix
                self.fileInputCleared = false;
                return;
            }
                ...
                if ($preview.length && FileReader !== undefined) {
                    ...
                    reader.onload = function (theFile) {
                        var hex,
                            ...
                            contents,
                            mime,
                            readTextImage = function readTextImage(textFlag) {
        ...
        refresh: function refresh(options, triggerChange) {
            var self = this,
                $el = self.$element;
            if ((typeof options === 'undefined' ? 'undefined' : _typeof(options)) !== 'object' || $h.isEmpty(options)) {
...
//# sourceMappingURL=fileinput-compiled.js.map