var Header = Vue.extend({
  ...
  "<div class='user-info'><div style='height: 24px;'>" +
  "<div style='float: right'>欢迎,{{ username }}<a id='logout' href='/logout/'>登出</a></div></div>" +
  "<ul id='top' style='cursor: pointer'><li @click=\"update_style('zhenduan')\" v-bind:class='{active: is_active_zd}'>" +
  "<a v-bind:style='{color:color_zd}'>疾病诊断</a></li>" +
  "<li @click=\"update_style('shoushu')\" v-bind:class='{ active: is_active_ss}'>" +
  "<a v-bind:style='{color:color_ss}'>手术操作</a></li><li><a href='#'>症状体征</a></li>" +
  "<li><a href='#'>检验检查</a></li><li><a href='#'>用药</a></li></ul></div></div>",
